...
class _ForecastState extends State<Forecast> {
  ...
  Widget build(BuildContext context) {
    ...
    // Penambahan 1 hari dari tanggal 17 April 2024
    DateTime nextDate = DateTime(2024, 4, 22).add(Duration(days: 1));
    return SafeArea(
      child: Scaffold(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${nextDate.day} ${month[nextDate.month - 1]} ${nextDate.year}', // Menggunakan tanggal selanjutnya dari 17 April 2024
                        style: TextStyle(
                            fontSize: 18, color: Colors.white.withOpacity(0.5)),
                      ),
                    ],
